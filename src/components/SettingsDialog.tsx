                ...
                {accessibilityProfiles.map((profile) => (
                  <div key={profile.value} className="flex items-center">
                    ...
                    <Label
                      ...
                      className="flex items-center gap-3 w-full cursor-pointer rounded-lg border border-muted bg-popover p-3 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-l-[3px] peer-data-[state=checked]:border-l-primary [&:has([data-state=checked])]:border-l-[3px] [&:has([data-state=checked])]:border-l-primary"
                    >
